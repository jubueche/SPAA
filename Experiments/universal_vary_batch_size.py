...
class universal_vary_batch_size:
    @staticmethod
    def train_grid():
    ...
    @staticmethod
    def visualize():
        grid = universal_vary_batch_size.train_grid()
        ...
        num_samples_list = [1,2,4,7,10] # - Number of samples per class label
        ...
        grid = split(grid, "num_samples", num_samples_list)
